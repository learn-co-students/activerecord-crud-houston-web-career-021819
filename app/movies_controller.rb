...
def can_be_instantiated_and_then_saved   #instantce in a class
  movie = Movie.new
  movie.title = "This is a title."
  movie.save
end

def can_be_created_with_a_hash_of_attributes  #row in a table
...
def can_get_the_first_item_in_the_database
  Movie.first #Movie is class, why call the class not the movies table?????
end
...
def can_find_using_where_clause_and_be_sorted
  ...
  movies = Movie.where("release_date > 2002").order("release_date DESC")  #desc has to be upcase
